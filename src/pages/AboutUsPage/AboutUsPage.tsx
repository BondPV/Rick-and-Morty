...
const AboutUsPage = () => (
  <div className={GLOBAL_STYLES.CONTAINER}>
    <div className={styles.about}>
      <p>
        <span>Rick and Morty</span> is an American adult animated science-fiction sitcom created by
        Justin by Justin Roiland and Dan Harmon for Cartoon Network`s nighttime programming block
      ...
      <p>
        ...
        The general concept of Rick and Morty relies on two conflicting scenarios: domestic family
        drama, and an alcoholic grandfather dragging his grandson into hijinks.
      </p>
    </div>
  </div>
);
